...
uint32_t FMC_CheckAllOne(uint32_t u32addr, uint32_t u32count)
{
    ...
    if (((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT == 0xA11FFFFFUL)
    {
        ret = ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT;
    }

    if (((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT == 0xA1100000UL)
    {
        ret = ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT;
    }
...
#line 450 "..\\..\\..\\Library\\StdDriver\\src\\fmc.c"
{
    ...
    do
    {
        ...
        for (i = idx; i < ((256UL) / 4u); i += 4u)  
        {
            ...
            while ((((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->MPSTS & (3u << (4))) && (err == 0));
            ...
            if (err == 0)
            {
                ...
                while ((((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->MPSTS & (3u << (6))) && (err == 0));
