...
#line 69 "..\\main.c"
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPL & ~((0xful << (8)) | (0xful << (12)))) |
                    ((0x06UL<<(8)) | (0x06UL<<(12)));
...
{
    UART_Open(((UART_T *) ((( uint32_t)0x40000000) + 0x71000)), 115200);
    UART_EnableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x71000)),((0x1ul << (0))|(0x1ul << (4))));
...
int main(void)
{
    ...
    if(((((WDT_T *) ((( uint32_t)0x40000000) + 0x40000))->CTL & (0x1ul << (2)))? 1UL : 0UL) == 1)
    {
        (((WDT_T *) ((( uint32_t)0x40000000) + 0x40000))->CTL = (((WDT_T *) ((( uint32_t)0x40000000) + 0x40000))->CTL & ~((0x1ul << (3)) | (0x1ul << (5)))) | (0x1ul << (2)));
    }
