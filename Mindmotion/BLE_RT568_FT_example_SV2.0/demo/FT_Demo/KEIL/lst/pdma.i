...
void PDMA_SetTransferMode(PDMA_T *pdma, uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    {
    case 0ul:
        pdma->REQSEL0_3 = (pdma->REQSEL0_3 & ~(0x3ful << (0))) | u32Peripheral;
        break;

    case 1ul:
        pdma->REQSEL0_3 = (pdma->REQSEL0_3 & ~(0x3ful << (8))) | (u32Peripheral << (8));
        break;

    case 2ul:
        pdma->REQSEL0_3 = (pdma->REQSEL0_3 & ~(0x3ful << (16))) | (u32Peripheral << (16));
        break;

    case 3ul:
        pdma->REQSEL0_3 = (pdma->REQSEL0_3 & ~(0x3ful << (24))) | (u32Peripheral << (24));
        break;

    case 4ul:
        pdma->REQSEL4_7 = (pdma->REQSEL4_7 & ~(0x3ful << (0))) | u32Peripheral;
        break;

    case 5ul:
        pdma->REQSEL4_7 = (pdma->REQSEL4_7 & ~(0x3ful << (8))) | (u32Peripheral << (8));
        break;

    case 6ul:
        pdma->REQSEL4_7 = (pdma->REQSEL4_7 & ~(0x3ful << (16))) | (u32Peripheral << (16));
        break;

    case 7ul:
        pdma->REQSEL4_7 = (pdma->REQSEL4_7 & ~(0x3ful << (24))) | (u32Peripheral << (24));
        break;

    case 8ul:
        pdma->REQSEL8 = (pdma->REQSEL8 & ~(0x3ful << (0))) | u32Peripheral;
        break;
