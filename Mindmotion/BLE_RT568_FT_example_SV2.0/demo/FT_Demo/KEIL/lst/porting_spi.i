...
void SPI_PDMA_Init(void)
{
    ...
    PDMA_SetTransferAddr(((PDMA_T *) ((( uint32_t)0x40000000) + 0x08000)), 3, 0, 0x00000000UL, (uint32_t)&((SPI_T *) ((( uint32_t)0x40000000) + 0x61000))->TX, 0x00000C00UL);
    PDMA_SetTransferAddr(((PDMA_T *) ((( uint32_t)0x40000000) + 0x08000)), 4, (uint32_t)&((SPI_T *) ((( uint32_t)0x40000000) + 0x61000))->RX, 0x00000300UL, 0, 0x00000000UL);
...
void SPI_PDMA_SetRx_Isr(uint8_t regAddr, uint32_t u32DstAddr, uint32_t u32TransCount)
{
    ...
    ( (((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))->PDMACTL &= ~(0x1ul << (1)) );
    ((PDMA_T *) ((( uint32_t)0x40000000) + 0x08000))->DSCT[3].SA = (uint32_t)TAB_ZERO_128; 
