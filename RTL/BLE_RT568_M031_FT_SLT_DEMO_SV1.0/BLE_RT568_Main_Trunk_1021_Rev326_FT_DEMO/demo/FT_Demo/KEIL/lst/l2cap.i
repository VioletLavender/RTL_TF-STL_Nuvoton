...
void Rls_L2CAP_Buf(void)
{
    L2CAP_Buf.connID_LL = 0xFF;
}


Uint8 CheckValid_L2CAP_Buf(void)
{
    if(L2CAP_Buf.connID_LL == 0xFF)
    {
        return 0;
    }
    else
...
void ML2CAP_Event_Null(MBLK *pMBlk)
{
    
}


void (* const L2CAP_fsm[])(MBLK *) =
{
    ML2CAP_Event_Null,
};


void L2CAP_Root(Uint8 QueueId)
{
    Uint8 event;
    MBLK *pmblk;
    ...
    event = pmblk->Primitive - 0x80;
    (*(L2CAP_fsm[event]))(pmblk);
