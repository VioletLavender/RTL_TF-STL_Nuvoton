...
#line 20 "..\\..\\..\\source\\mmi.c"
#line 21 "..\\..\\..\\source\\mmi.c"
...
#line 22 "..\\..\\..\\source\\mmi.c"
#line 1 "..\\..\\..\\include\\rf_include\\mmi.h"
...
#line 24 "..\\..\\..\\source\\mmi.c"
#line 25 "..\\..\\..\\source\\mmi.c"
...
#line 28 "..\\..\\..\\source\\mmi.c"
#line 29 "..\\..\\..\\source\\mmi.c"
#line 1 "..\\..\\..\\porting\\porting_flash.h"
...
#line 31 "..\\..\\..\\porting\\porting_flash.h"




#line 30 "..\\..\\..\\source\\mmi.c"
...
Uint8 ATT_INDICATION_Packet_Sent = 0;
Uint8 ATT_WRITE_REQUEST_Packet_Sent = 0;
#line 234 "..\\..\\..\\source\\mmi.c"
...
Uint8 Prcss_L2CAP_CID_NULL_IDENTIFIER(Uint8 connID);
Uint8 Prcss_L2CAP_CID_L2CAP_SIGNALING_CHANNEL(Uint8 connID);
Uint8 Prcss_L2CAP_CID_CONNECTIONLESS_CHANNEL(Uint8 connID);
Uint8 Prcss_L2CAP_CID_AMP_MANAGER_PROTOCOL(Uint8 connID);
Uint8 Prcss_L2CAP_CID_ATTRIBUTE_PROTOCOL(Uint8 connID);
Uint8 Prcss_L2CAP_CID_LE_L2CAP_SIGNALING_CHANNEL(Uint8 connID);
Uint8 Prcss_L2CAP_CID_SECURITY_MANAGER_PROTOCOL(Uint8 connID);

Uint8 Prcss_OPCODE_ATT_NULL(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Error_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Exchange_MTU_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Exchange_MTU_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Find_Information_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Find_Information_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Find_By_Type_Value_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Find_By_Type_Value_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_By_Type_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_By_Type_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Blob_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Blob_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Multiple_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_Multiple_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_by_Group_Type_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Read_by_Group_Type_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Write_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Write_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Prepare_Write_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Prepare_Write_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Execute_Write_Request(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Execute_Write_Response(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Handle_Value_Notification(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Handle_Value_Indication(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Handle_Value_Confirmation(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Write_Command(Uint8 connID);
Uint8 Prcss_OPCODE_ATT_Signed_Write_Command(Uint8 connID);


Uint8 Prcss_BLE_CODE_SMP_Reserved(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Pairing_Request(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Pairing_Response(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Pairing_Confirm(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Pairing_Random(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Pairing_Failed(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Encryption_Information(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Master_Identification(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Identity_Information(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Identity_Address_Information(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Signing_Information(Uint8 connID);
Uint8 Prcss_BLE_CODE_SMP_Security_Request(Uint8 connID);
Uint8 (* const Prcss_BLE_CODE_SMP[])(Uint8 connID) =
{
...
Uint8 (* const Prcss_L2CAP_CID[])(Uint8 connID) =
{
    Prcss_L2CAP_CID_NULL_IDENTIFIER,
    Prcss_L2CAP_CID_L2CAP_SIGNALING_CHANNEL,
    Prcss_L2CAP_CID_CONNECTIONLESS_CHANNEL,
    Prcss_L2CAP_CID_AMP_MANAGER_PROTOCOL,
    Prcss_L2CAP_CID_ATTRIBUTE_PROTOCOL,
    Prcss_L2CAP_CID_LE_L2CAP_SIGNALING_CHANNEL,
    Prcss_L2CAP_CID_SECURITY_MANAGER_PROTOCOL
};


Uint8 (* const Prcss_BLE_OPCODE_ATT[])(Uint8 connID) =
{
...
Uint8 Prcss_L2CAP_CID_ATTRIBUTE_PROTOCOL(Uint8 connID)
{
    if((L2CAP_Buf.DataBuf[(0+4)] & 0xE0) == 0)
    {
        if(L2CAP_Buf.DataBuf[(0+4)] <= 0X1E)
        {
            if((Prcss_BLE_OPCODE_ATT[L2CAP_Buf.DataBuf[(0+4)]](connID)) == 0)
            {
                return 0;
            }
            else
        ...
        {
            if(setBLE_ConnTxData_ATT_ERROR_RESPONSE(connID, L2CAP_Buf.DataBuf[(0+4)], 0, 0, 0x06) == 0)
            {
                return 0;
            }
            else
    ...
    else
    {
        ...
        switch(L2CAP_Buf.DataBuf[(0+4)])
        {
        case 0X52:
            if(Prcss_OPCODE_ATT_Write_Command(connID) == 0)
            {
                return 0;
            }
            else
        ...
        case 0XD2:
            if(Prcss_OPCODE_ATT_Signed_Write_Command(connID) == 0)
            {
                return 0;
            }
            else
...
Uint8 Prcss_L2CAP_CID_LE_L2CAP_SIGNALING_CHANNEL(Uint8 connID)
{
    ...
    i = L2CAP_Buf.DataBuf[(0+4)];
    if(i <= 0x13)
    {
        switch(i)
        {
        case 0x13:
            i = L2CAP_Buf.DataBuf[((0+4)+1)];                
            return 0;
        ...
        default:
            ...
            SPIBuffer[((0+4)+2)] = 2;
            SPIBuffer[((0+4)+3)] = 0;
            SPIBuffer[((0+4)+3)+1] = 0x00;     
            SPIBuffer[((0+4)+3)+2] = 0x00;
            if(setBLE_ConnTxData(connID, SPIBuffer, (SPIBuffer[0]+4)) == 0)
            {
                return 0;
            }
            else
...
Uint8 Prcss_L2CAP_CID_SECURITY_MANAGER_PROTOCOL(Uint8 connID)
{
    ...
    i = L2CAP_Buf.DataBuf[4];
    if(i <= 0x0B)
    {
        if((Prcss_BLE_CODE_SMP[i](connID)) == 0)
        {
            return 0;
        }
        else
...
Uint8 Prcss_OPCODE_ATT_Exchange_MTU_Request(Uint8 connID)
{
    Uint16 aTT_MTU_central;

    extern void BleMHC_PostEvent(BleCmdEvent event, void *parms);

    aTT_MTU_central = L2CAP_Buf.DataBuf[((0+4)+1)] | (L2CAP_Buf.DataBuf[((0+4)+2)] << 8);
    if(aTT_MTU_central > 247)
    {
        aTT_MTU_central = 247;
    }
    aTT_MTU[connID] = aTT_MTU_central;

    SPIBuffer[(0+4)] = 0X03;
    SPIBuffer[((0+4)+1)] = aTT_MTU[connID];
    SPIBuffer[((0+4)+2)] = 0x00;
    if(setBLE_ConnTxData(connID, SPIBuffer, (SPIBuffer[0]+4)) == 0)
    {

        BleMHC_PostEvent(0x10,(void *)&aTT_MTU[connID]);
...
Uint8 Prcss_OPCODE_ATT_Exchange_MTU_Response(Uint8 connID)
{
    ...
    uint16_t aTT_MTU_peripheral;

    extern void BleMHC_PostEvent(BleCmdEvent event, void *parms);

    aTT_MTU_peripheral = L2CAP_Buf.DataBuf[((0+4)+1)] | (L2CAP_Buf.DataBuf[((0+4)+2)] << 8);
    if(aTT_MTU_peripheral > 247)
    {
        aTT_MTU_peripheral = 247;
    }
    if(aTT_MTU[connID] > aTT_MTU_peripheral)
    {
        aTT_MTU[connID] = aTT_MTU_peripheral;
    }
...
Uint8 Prcss_OPCODE_ATT_Find_Information_Request(Uint8 connID)
{
    ...
    Uint8 Handle_Att_RPT_S;     
    Uint8 Handle_Att_RPT_E;     
    Uint8 sizeRSP_PDUlgth;
    Uint8 i, j, idx, att_format;                    

    Rsp_Error = 1;
    if(L2CAP_Buf.DataBuf[((0+4)+2)] == L2CAP_Buf.DataBuf[((0+4)+4)])
    {
        if(L2CAP_Buf.DataBuf[((0+4)+1)] <= L2CAP_Buf.DataBuf[((0+4)+3)])
        {
            Rsp_Error = 0;
        }
    }
    else if(L2CAP_Buf.DataBuf[((0+4)+2)] < L2CAP_Buf.DataBuf[((0+4)+4)])
    {
        Rsp_Error = 0;
    }
    if(L2CAP_Buf.DataBuf[((0+4)+1)] == 0)
    {
        if(L2CAP_Buf.DataBuf[((0+4)+2)] == 0)
        {
            Rsp_Error = 1;
        }
    }
    ...
    if(Rsp_Error != 0)  
    {
        if(setBLE_ConnTxData_ATT_ERROR_RESPONSE(connID, L2CAP_Buf.DataBuf[(0+4)], L2CAP_Buf.DataBuf[((0+4)+1)], L2CAP_Buf.DataBuf[((0+4)+2)], 0x01) == 0)
        {
            return 0;
        }
        else
    ...
    else
    {
        ...
        do
        {
            if(ATTRIBUTE_SERVER[i][0] >= L2CAP_Buf.DataBuf[((0+4)+2)])
            {
                if(ATTRIBUTE_SERVER[i][(0+1)] >= L2CAP_Buf.DataBuf[((0+4)+1)])
                {
                    Handle_Att_RPT_S = i;
                    Rsp_Error = 0;
                    break;
    ...
    if(Rsp_Error == 0)
    {
        ...
        do
        {
            if(ATTRIBUTE_SERVER[i][0] <= L2CAP_Buf.DataBuf[((0+4)+4)])
            {
                if(ATTRIBUTE_SERVER[i][(0+1)] <= L2CAP_Buf.DataBuf[((0+4)+3)])
                {
                    Handle_Att_RPT_E = i;
                    Rsp_Error = 0;
                }
    ...
    {
        SPIBuffer[(0+4)] = 0X05;
        SPIBuffer[((0+4)+1)] = (ATTRIBUTE_SERVER_PERMISSION[Handle_Att_RPT_S][0x01] & 0x03);   
        att_format = SPIBuffer[((0+4)+1)];
        sizeRSP_PDUlgth = 2;                  
        i = (((0+4)+1)+1);
        do
        {
            if(att_format != (ATTRIBUTE_SERVER_PERMISSION[Handle_Att_RPT_S][0x01] & 0x03))
                break;
            idx = getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S);
            j = (sizeRSP_PDUlgth+idx+2);
            if(aTT_MTU[connID] < j)
                break;
            sizeRSP_PDUlgth = j;
            SPIBuffer[i] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+1)];
            i++;
            SPIBuffer[i] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][0];
            i++;
            j = i+idx;
            idx = idx + ((0+2) - 1);
            while(i < j)
            {
                SPIBuffer[i] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][idx];
        ...
        while(Handle_Att_RPT_S <= Handle_Att_RPT_E);
        SPIBuffer[0] = sizeRSP_PDUlgth;
        SPIBuffer[(0+1)] = 0;
        SPIBuffer[(0+2)] = 0x04;
        SPIBuffer[(0+3)] = 0;
        if(setBLE_ConnTxData(connID, SPIBuffer, (sizeRSP_PDUlgth+4)) == 0)
        {
            return 0;
        }
        else
    ...
    {
        if(setBLE_ConnTxData_ATT_ERROR_RESPONSE(connID, SPIBuffer[(0+4)], SPIBuffer[((0+4)+1)], SPIBuffer[((0+4)+2)], 0x0A) == 0)
        {
            return 0;
        }
        else
...
Uint8 Prcss_OPCODE_ATT_Find_By_Type_Value_Request(Uint8 connID)
{
    ...
    if((L2CAP_Buf.DataBuf[((0+4)+1)] == 0)&&(L2CAP_Buf.DataBuf[((0+4)+2)] == 0))
    {
        Rsp_Error = 0x01;
    }
    if(Rsp_Error == 0)
    {
        if(L2CAP_Buf.DataBuf[(((0+4)+4)+2)] != 0x28)
        {
            Rsp_Error = 0x06;
        }
    }
    if(Rsp_Error == 0)
    {
        ...
        do
        {
            if((ATTRIBUTE_SERVER[i][(0+2)] == L2CAP_Buf.DataBuf[(((0+4)+4)+2)])&&(ATTRIBUTE_SERVER[i][(0+3)] == L2CAP_Buf.DataBuf[(((0+4)+4)+1)]))
            {
                for(idx=0; idx<size_uuid; idx++)
                {
                    if(*(*(ATTRIBUTE_SERVER_PARAM+i)+idx) != L2CAP_Buf.DataBuf[idx+((((0+4)+4)+2)+1)])
                        break;
                }
                if(idx == size_uuid)
                    if((ATTRIBUTE_SERVER[i][0] >= L2CAP_Buf.DataBuf[((0+4)+2)])&&(ATTRIBUTE_SERVER[i][(0+1)] >= L2CAP_Buf.DataBuf[((0+4)+1)]))
                    {
                        Handle_Att_RPT_S = i;
                        Handle_Att_RPT_E = i;
                        Rsp_Error = 0;
    ...
    {
        SPIBuffer[(0+4)] = 0X07;
        SPIBuffer[((0+4)+1)] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+1)];
        SPIBuffer[((0+4)+2)] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][0];
        SPIBuffer[((0+4)+3)] = ATTRIBUTE_SERVER[Handle_Att_RPT_E][(0+1)];
        SPIBuffer[((0+4)+4)] = ATTRIBUTE_SERVER[Handle_Att_RPT_E][0];
        SPIBuffer[0] = 5;
        SPIBuffer[(0+1)] = 0;
        SPIBuffer[(0+2)] = 0x04;
        SPIBuffer[(0+3)] = 0;
        if(setBLE_ConnTxData(connID, SPIBuffer, (5+4)) == 0)
        {
            return 0;
        }
        else
    ...
    {
        if(setBLE_ConnTxData_ATT_ERROR_RESPONSE(connID, SPIBuffer[(0+4)], SPIBuffer[((0+4)+1)], SPIBuffer[((0+4)+2)], Rsp_Error) == 0)
        {
            return 0;
        }
        else
...
Uint8 Prcss_OPCODE_ATT_Read_By_Type_Request(Uint8 connID)
{
    ...
    if(Rsp_Error == 0)
    {
        if(L2CAP_Buf.DataBuf[0] == (5+2))        
        {
            size_uuid = 2;
        }
        else if(L2CAP_Buf.DataBuf[0] == (5+16))  
        {
            size_uuid = 16;
        }
        else
    ...
    if(Rsp_Error == 0)
    {
        ...
        while(Handle_Att_RPT_S <= Handle_Att_RPT_E)
        {
            ...
            {
                idx--;
                if(L2CAP_Buf.DataBuf[(((0+4)+4)+1)+i] != ATTRIBUTE_SERVER[Handle_Att_RPT_S][((0+2)+idx)])
                {
                    break;
                }
                else
                {
                    uuid[idx] = L2CAP_Buf.DataBuf[(((0+4)+4)+1)+i];
                }
                i++;
            }
    ...
    if(Rsp_Error == 0)
    {
        ...
        while(Handle_Att_RPT_S <= Handle_Att_RPT_E)
        {
            size_temp = (size_uuid+1);
            if(getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S) == size_uuid)
                size_temp = 0;
            while(size_temp < size_uuid)
            {
                if(uuid[size_temp] != ATTRIBUTE_SERVER[Handle_Att_RPT_S][((0+2)+size_temp)])
                    break;
                size_temp++;
            }
            if(size_temp == size_uuid)
            {
                
                Rsp_Error = chkBLE_ATTRIBUTE_PERMISSION_Read(Handle_Att_RPT_S);
                
                if(Rsp_Error == 0)
                {
                    Rsp_Error = chkIfBLE_ATT_Chr_Acss_ByUser(Handle_Att_RPT_S);
                    if(Rsp_Error != 0)
                    {
                        Rsp_Error = chkBLE_ATT_Chr_AcssRd_ByUser((Uint8 *)*(ATTRIBUTE_SERVER_PARAM+Handle_Att_RPT_S));
                    }
                }
                if(Rsp_Error != 0)
                {
                ...
                {
                    size = (ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S)] + 2);
                    size = getBLE_ATTRIBUTE_Value_DynmcLngth(Handle_Att_RPT_S, size);
                    if(size < (aTT_MTU[connID]+5-idx))
                    {
                        size_temp = size;
                        i = Handle_Att_RPT_S;
                    }
                    ...
                    if(i != 0)
                    {
                        ...
                        {
                            SPIBuffer[((0+4)+1)] = size;
                        }
                        SPIBuffer[idx] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+1)];
                        idx++;
                        SPIBuffer[idx] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][0];
                        idx++;
                        sizeRSP_PDUlgth = (sizeRSP_PDUlgth+2);
                        size_temp = (size_temp-2);
                        size = 0;
                        while(size_temp != 0)
                        {
                            SPIBuffer[idx] = *(*(ATTRIBUTE_SERVER_PARAM+Handle_Att_RPT_S)+(0+size));
                            idx++;
                            sizeRSP_PDUlgth++;
                            size++;
                            size_temp--;
    ...
    if(Rsp_Error == 0)
    {
        ...
        if(SPIBuffer[((0+4)+1)] > (aTT_MTU[connID] - 2))
        {
            SPIBuffer[((0+4)+1)] = (aTT_MTU[connID] -2);
        }
        if(setBLE_ConnTxData(connID, SPIBuffer, (sizeRSP_PDUlgth+4)) == 0)
        {
            return 0;
...
Uint8 Prcss_OPCODE_ATT_Read_Request(Uint8 connID)
{
    ...
    if(Rsp_Error == 0)
    {
        ...
        Rsp_Error = chkBLE_ATTRIBUTE_PERMISSION_Read(i);
    }
    if(Rsp_Error == 0)
    {
        Rsp_Error = chkIfBLE_ATT_Chr_Acss_ByUser(i);
        if(Rsp_Error != 0)
        {
            
            Rsp_Error = chkBLE_ATT_Chr_AcssRd_ByUser((Uint8 *)*(ATTRIBUTE_SERVER_PARAM+i));
        }
    }
    if(Rsp_Error != 0)
    {
    ...
    {
        mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HSPF_Att_Read_Para.HCI_DataPkt_Data));
        if(mblk == (MBLK *)0)
        {
            return (!0);
        }

        mblk->Primitive = (0x90+0x02);
        mblk->Para.HSPF_Att_Read_Para.HCI_DataPkt_LthL = 3;
        mblk->Para.HSPF_Att_Read_Para.HCI_Conn_Hdl_L = connID;
        mblk->Para.HSPF_Att_Read_Para.HCI_Conn_Hdl_H = i;
        Knl_MemCpy(mblk->Para.HSPF_Att_Read_Para.HCI_DataPkt_Data, &SPIBuffer[(0+4)], 3);

        

        idx = 0;
        sizeRSP_PDUlgth = 1;    
        Rsp_Error = ATTRIBUTE_SERVER[i][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i)];
        Rsp_Error = getBLE_ATTRIBUTE_Value_DynmcLngth(i, Rsp_Error);
        while(idx < Rsp_Error)
        {
            SPIBuffer[(((0+4)+1)+idx)] = *(*(ATTRIBUTE_SERVER_PARAM+i)+(0+idx));
            idx++;
            sizeRSP_PDUlgth++;
            if(sizeRSP_PDUlgth > (aTT_MTU[connID] - 1))
            {
                break;
            }
        }
...
Uint8 Prcss_OPCODE_ATT_Read_Blob_Request(Uint8 connID)
{
    ...
    if(Rsp_Error == 0)
    {
        idx_AttTypeSize = ATTRIBUTE_SERVER[i][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i)];
        idx_AttTypeSize = getBLE_ATTRIBUTE_Value_DynmcLngth(i, idx_AttTypeSize);
        if(idx_AttTypeSize <= (aTT_MTU[connID] - 3))
        {
            if(L2CAP_Buf.DataBuf[(((0+4)+2)+1)] != 0)
            {
                Rsp_Error = 0x0B;
            }
        }
    ...
    if(Rsp_Error == 0)
    {
        if(L2CAP_Buf.DataBuf[(((0+4)+2)+1)] > idx_AttTypeSize)
        {
            Rsp_Error = 0x07;
        }
        else
        {
            if(L2CAP_Buf.DataBuf[(((0+4)+2)+1)] == idx_AttTypeSize)
            {
                ...
                SPIBuffer[(0+2)] = 0x04;
                SPIBuffer[(0+3)] = 0;
                if(setBLE_ConnTxData(connID, SPIBuffer, (1+4)) == 0)
                {
                    return 0;
                }
                else
    ...
    else    
    {
        idx = 0;
        sizeRSP_PDUlgth = 1;    
        j = L2CAP_Buf.DataBuf[(((0+4)+2)+1)];
        while((j+idx) < idx_AttTypeSize)
        {
            SPIBuffer[(((0+4)+1)+idx)] = *(*(ATTRIBUTE_SERVER_PARAM+i)+(0+j+idx));
            idx++;
            sizeRSP_PDUlgth++;
            if(sizeRSP_PDUlgth > (aTT_MTU[connID] - 1))
            {
...
Uint8 Prcss_OPCODE_ATT_Read_Multiple_Request(Uint8 connID)
{
    if(setBLE_ConnTxData_ATT_ERROR_RESPONSE(connID, SPIBuffer[(0+4)], 0, 0, 0x06) == 0)
    {
        return 0;
    }
    else
...
Uint8 Prcss_OPCODE_ATT_Read_by_Group_Type_Request(Uint8 connID)
{
    ...
    Uint8 size_each_Att_Data;
    Uint8 Handle_Att_RPT_S;     
    Uint8 Handle_Att_RPT_E;     
    Uint8 uuid[16];

    Uint8 size_temp, size_uuid;
    Uint8 sizeRSP_PDUlgth;
    Uint8 i, idx;                    
    ...
    if(Rsp_Error == 0)
    {
        ...
        {
            if((uuid[2]==0x28)&&(uuid[3]<=0x01))
            {
                if((uuid[0] == 0)&&(uuid[1] == 0))                  
                {
                    for(i=4; i<16; i++)
                    {
                        if(uuid[i] != UUID_BLUETOOTH_BASE[i])
                            break;
                    }
                    if(i==16)
                    {
    ...
    if(Rsp_Error == 0)
    {
        ...
        while(Handle_Att_RPT_S <= Handle_Att_RPT_E)
        {
            if(getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S) == 2)
            {
                if((uuid[0] == ATTRIBUTE_SERVER[Handle_Att_RPT_S][((0+2))])&&(uuid[1] == ATTRIBUTE_SERVER[Handle_Att_RPT_S][((0+3))]))
                {
                    Rsp_Error = chkBLE_ATTRIBUTE_PERMISSION_Read(Handle_Att_RPT_S);
                    break;
                }
    ...
    else    
    {
        ...
        while(Handle_Att_RPT_S <= Handle_Att_RPT_E)
        {
            if(getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S) == 2)   
            {
                if((ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+2)] == uuid[0])&&(ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+3)] == uuid[1]))
                {
                    Rsp_Error = chkBLE_ATTRIBUTE_PERMISSION_Read(Handle_Att_RPT_S);
                    if(Rsp_Error != 0)
                    {
                    ...
                    {
                        size_each_Att_Data = (ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(Handle_Att_RPT_S)] + 4); 
                        if(idx != (((0+4)+1)+1))
                        {
                            if(size_each_Att_Data != SPIBuffer[((0+4)+1)])
                            {
                                break;
                            }
                        }
                        if(idx < (aTT_MTU[connID]+4-size_each_Att_Data))
                        {
                            size_temp = size_each_Att_Data;
                            SPIBuffer[idx] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][(0+1)];
                            idx++;
                            SPIBuffer[idx] = ATTRIBUTE_SERVER[Handle_Att_RPT_S][0];
                            idx++;
                            sizeRSP_PDUlgth = (sizeRSP_PDUlgth+2);
                            if(Handle_Att_RPT_S != (size_ATTRIBUTE_SERVER-1))
                            {
                                i = Handle_Att_RPT_S+1;
                                while(i < (size_ATTRIBUTE_SERVER-1))
                                {
                                    if((ATTRIBUTE_SERVER[i][(0+2)] == uuid[0])&&(ATTRIBUTE_SERVER[i][(0+3)] == uuid[1]))
                                    {
                                        i = i-1;
                                        break;
                                    }
                            ...
                            SPIBuffer[idx] = ATTRIBUTE_SERVER[i][(0+1)];
                            idx++;
                            SPIBuffer[idx] = ATTRIBUTE_SERVER[i][0];
                            idx++;
                            sizeRSP_PDUlgth = (sizeRSP_PDUlgth+2);
                            size_temp = (size_temp-4);  
                            size_each_Att_Data = 0;
                            while(size_temp != 0)
                            {
                                SPIBuffer[idx] = *(*(ATTRIBUTE_SERVER_PARAM+Handle_Att_RPT_S)+(0+size_each_Att_Data));
                                idx++;
                                sizeRSP_PDUlgth++;
                                size_each_Att_Data++;
                                size_temp--;
                            }
                            size_each_Att_Data = i;
                            i = Handle_Att_RPT_S;
                            SPIBuffer[((0+4)+1)] = (ATTRIBUTE_SERVER[(i)][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i)]) + 4;    
                            Handle_Att_RPT_S = size_each_Att_Data;
                        }
                        else
                        {
                            break;
...
Uint8 Prcss_OPCODE_ATT_Write_Request(Uint8 connID)
{
    ...
    Uint8 *tmp;
    extern Uint8* cmd_FlashBond(uint8_t opcode, uint8_t * para_data);


    extern void (* const ATT_Write[])(uint8_t connID, uint8_t length, uint8_t *srcCMD);
    ...
    if(Rsp_Error == 0)
    {
        Rsp_Error = chkBLE_ATTRIBUTE_PERMISSION_Write(i);
    }
    if(Rsp_Error == 0)
    {
        if(L2CAP_Buf.DataBuf[0] > (*(*(ATTRIBUTE_SERVER+i)+((0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i))) + 3))
        {
            Rsp_Error = 0x0D;
        }
    }
    ...
    if(Rsp_Error == 0)
    {
        ...
        if(Rsp_Error != 0)
        {
            Rsp_Error = chkBLE_ATT_Chr_AcssWr_ByUser((Uint8 *)*(ATTRIBUTE_SERVER_PARAM+i), &(L2CAP_Buf.DataBuf[(((0+4)+2)+1)]));
        }
    }
    if(Rsp_Error != 0)
    {
    ...
    else    
    {
        ...
        if(setBLE_ConnTxData(connID, SPIBuffer, (1+4)) == 0)     
        {
            (*(ATT_Write[i]))(connID, (L2CAP_Buf.DataBuf[0]-3), &L2CAP_Buf.DataBuf[(0+4)+3]);

            for(idx=0; idx<(L2CAP_Buf.DataBuf[0]-3); idx++)
            {
                pATT_param = (Uint8 *)(*(ATTRIBUTE_SERVER_PARAM+i));
                *(pATT_param+idx) = L2CAP_Buf.DataBuf[(idx+((0+4)+2)+1)];     
            }
            if((*(*(ATTRIBUTE_SERVER_PERMISSION+i)+0x01) & 0x04) != 0)
            {
                pATT_param = (Uint8 *)(*(ATTRIBUTE_SERVER_PARAM+i));
                pATT_param[(ATTRIBUTE_SERVER[i][(0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i)])] = idx;
            }



            if(smp_Security_Mode >= 0x01)
            {
                for(idx=0; idx<size_ATTRIBUTE_SERVER_BOND; idx++)
                {
                    if(ATTRIBUTE_SERVER_BOND[idx][0] == ATTRIBUTE_SERVER[i][0])
                    {
                        if(ATTRIBUTE_SERVER_BOND[idx][(0+1)] == ATTRIBUTE_SERVER[i][(0+1)])
                        {
                            break;
                        }
                    }
                }
                if(idx != size_ATTRIBUTE_SERVER_BOND)
                {
                    tmp = cmd_FlashBond(0x05, (uint8_t*)smp_Para_Bond_tmp);
                    if(*tmp == 0x00)
                    {
                        tmp = cmd_FlashBond(0x07, (uint8_t*)smp_Para_Bond_tmp);
                        if(*tmp == 0x00)
                        {
                            if((*(tmp+3) + 2 + (L2CAP_Buf.DataBuf[0]-3)) > 128)
                            {
                                tmp = cmd_FlashBond(0x05, (uint8_t*)smp_Para_Bond_tmp);
                                tmp = cmd_FlashBond(0x08, (uint8_t*)smp_Para_Bond_tmp);

                                if(*tmp == 0x00)
                                {
                                    for(idx=0; idx<size_ATTRIBUTE_SERVER_BOND; idx++)
                                    {
                                        for(i=0; i<(ATTRIBUTE_SERVER_BOND[idx][4]); i++)
                                        {
                                            *(tmp+((3+3)+i)) = ATTRIBUTE_SERVER_BOND_PARAM[idx][i];
                                        }
                                        *(tmp+(3+1)) = idx;
                                        *(tmp+(3+2)) = ATTRIBUTE_SERVER_BOND[idx][4];
                                        tmp = cmd_FlashBond(0x09, (uint8_t*)smp_Para_Bond_tmp);
                                        tmp = cmd_FlashBond(0x07, (uint8_t*)smp_Para_Bond_tmp);
                                    }
                                }
                            }
...
Uint8 Prcss_OPCODE_ATT_Write_Response(Uint8 connID)
{
    ATT_WRITE_REQUEST_Packet_Sent = 0;
...
Uint8 Prcss_OPCODE_ATT_Prepare_Write_Request(Uint8 connID)
{
    ...
    do
    {
        if(ATTRIBUTE_SERVER[i][0] == L2CAP_Buf.DataBuf[((0+4)+2)])
        {
            if(ATTRIBUTE_SERVER[i][(0+1)] == L2CAP_Buf.DataBuf[((0+4)+1)])
            {
                if((q_att_HDL_PreWr[0]==0)&&(q_att_HDL_PreWr[1]==0))
                {
                    Knl_MemCpy(q_att_HDL_PreWr, &L2CAP_Buf.DataBuf[((0+4)+1)], 2);
                }
                else
                {
                    if(Knl_MemComp(q_att_HDL_PreWr, &L2CAP_Buf.DataBuf[((0+4)+1)], 2) != 0)
                    {
                        Rsp_Error = 0x80;
                        break;
                    }
    ...
    if(Rsp_Error == 0)
    {
        j = L2CAP_Buf.DataBuf[0]+L2CAP_Buf.DataBuf[(((0+4)+2)+1)]-5;
        if(j > *(*(ATTRIBUTE_SERVER+i)+((0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i))))
        {
            Rsp_Error = 0x09;
        }
        else
        {
            if(j > q_att_HDL_PreWr[2])
                q_att_HDL_PreWr[2] = j;
        }
    }
    if(Rsp_Error != 0)
    ...
    {
        Knl_MemCpy(&q_att_HDL_PreWr[3+L2CAP_Buf.DataBuf[(((0+4)+2)+1)]], &L2CAP_Buf.DataBuf[((((0+4)+2)+2)+1)], (L2CAP_Buf.DataBuf[0]-5));
        SPIBuffer[(0+4)] = 0X17;
        if(setBLE_ConnTxData(connID, SPIBuffer, (SPIBuffer[0]+4)) == 0)    
        {
            return 0;
...
Uint8 Prcss_OPCODE_ATT_Execute_Write_Request(Uint8 connID)
{
    ...
    extern void (* const ATT_Write[])(uint8_t connID, uint8_t length, uint8_t *srcCMD);
    Rsp_Error = 0;
    if(L2CAP_Buf.DataBuf[((0+4)+1)] == 0x01)
    {
        i = 0;
        if((q_att_HDL_PreWr[0]!=0)||(q_att_HDL_PreWr[1]!=0))
        {
            do
            {
                if(ATTRIBUTE_SERVER[i][0] == q_att_HDL_PreWr[1])
                {
                    if(ATTRIBUTE_SERVER[i][(0+1)] == q_att_HDL_PreWr[0])
                    {
                        j = *(*(ATTRIBUTE_SERVER+i)+((0+4)-2+getBLE_ATTRIBUTE_TYPE_Size(i)));
                        if(q_att_HDL_PreWr[2] > j)
                        {
                            Rsp_Error = 0x0D;
                            break;
                        }
                        Knl_MemCpy((Uint8 *)(*(ATTRIBUTE_SERVER_PARAM+i)), &q_att_HDL_PreWr[3], q_att_HDL_PreWr[2]);
    ...
    else    
    {
        ...
        if(setBLE_ConnTxData(connID, SPIBuffer, (1+4)) == 0)    
        {
            if(L2CAP_Buf.DataBuf[((0+4)+1)] == 0x01)
            {
                (*(ATT_Write[i]))(connID, q_att_HDL_PreWr[2], &q_att_HDL_PreWr[3]);

                if((*(*(ATTRIBUTE_SERVER_PERMISSION+i)+0x01) & 0x04) != 0)
                {
                    pATT_param = (Uint8 *)ATTRIBUTE_SERVER_PARAM[i];
                    pATT_param[j] = q_att_HDL_PreWr[2];
                }
            }
            init_q_att_HDL_PreWr();
...
Uint8 Prcss_OPCODE_ATT_Handle_Value_Notification(Uint8 connID)
{
#line 2384 "..\\..\\..\\source\\mmi.c"

#line 2397 "..\\..\\..\\source\\mmi.c"
    return 0;
}
...
extern void SndMsgBlkEC(MBLK *pMsgBlk);
Uint8 PassEC_BLE_CODE_SMP(Uint8 connID, Uint8 Primitive, Uint8 *source, Uint8 length)
{
    MBLK *mblk;
    mblk = GetMsgBlk_L2_wSize(((6+31+7)-2-1));
    if(mblk == (MBLK *)0)
    {
        return (!0);
    }

    mblk->Primitive = Primitive;
    mblk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_Conn_Hdl_L = connID;
    Knl_MemCpy(mblk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_DataPkt_Data, source, length);
    SndMsgBlkEC(mblk);
    return 0;
}
...
Uint8 Prcss_BLE_CODE_SMP_Pairing_Request(Uint8 connID)
{
    ...
    if(L2CAP_Buf.DataBuf[((0+4)+4)] < 16)
    {

    }
    smp_PReq_IO_Capab = L2CAP_Buf.DataBuf[((0+4)+1)];
    smp_PReq_OOB_data = L2CAP_Buf.DataBuf[((0+4)+2)];
    smp_Para_Bond[36] = L2CAP_Buf.DataBuf[((0+4)+3)];

    smp_Para_Bond[17] = L2CAP_Buf.DataBuf[((0+4)+4)];
    smp_PReq_Init_Key_Distr = L2CAP_Buf.DataBuf[((0+4)+5)];
    smp_PReq_Resp_Key_Distr = L2CAP_Buf.DataBuf[((0+4)+6)];

    if(((smp_Para_Bond[36] | rsp_pairing_request_table[((0+4)+3)]) & 0x04) == 0)
    {
        smp_Para_Bond[19] = 0x00;
    }
    else
    {
        smp_Para_Bond[19] = SEL_STK_GEN_MTHD[(rsp_pairing_request_table[((0+4)+1)])][smp_PReq_IO_Capab];
    }

    if((smp_Para_Bond[17] > 6)&&(smp_Para_Bond[17] < 17))
    {
        mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.MHC_Le_Stk_Gen_Para));
        if(mblk == (MBLK *)0)
        {
            return (!0);
        }

        mblk->Primitive = (0x60+0x15);
        mblk->Para.MHC_Le_Stk_Gen_Para.HCI_Conn_Hdl_L = connID;
        mblk->Para.MHC_Le_Stk_Gen_Para.HCI_STK_GEN_MTHD = smp_Para_Bond[19];
        

        smpPasskey_init();
        if(setBLE_ConnTxData(connID, (Uint8 *)rsp_pairing_request_table, (RSP_PAIRING_REQUEST[0]+4)) == 0)
        {
            smp_Phase = 1;      
            smp_TempDef = 0x00;
            SndMsgBlk(mblk, 4);
    ...
    else
    {
        ...
        mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.MHC_Le_Auth_status_Para));
        if(mblk == (MBLK *)0)
        {
            return (!0);
        }
        mblk->Primitive = (0x60+0x17);
        mblk->Para.MHC_Le_Auth_status_Para.HCI_Conn_Hdl_L = connID;
        mblk->Para.MHC_Le_Auth_status_Para.HCI_AUTH_STATUS = 0x06;
        SndMsgBlk(mblk, 4);

        setBLE_ConnTxData_SMP(connID, 0x05, &i, 1);
        return 0;
    }
...
Uint8 Prcss_BLE_CODE_SMP_Pairing_Confirm(Uint8 connID)
{
    ...
    if(smp_TempDef == 0x00)
    {
        Knl_MemCpyInv(smp_Temp16, &L2CAP_Buf.DataBuf[((0+4)+1)], 16);
        smp_TempDef = 0x01;
    }
    switch(smp_Para_Bond[19])
    {
    case 0x02:
    case 0x01:
        mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.MHC_Le_Stk_Gen_Para));
...
Uint8 Prcss_BLE_CODE_SMP_Pairing_Random(Uint8 connID)
{
    if(PassEC_BLE_CODE_SMP(connID, (0x50+0x07), L2CAP_Buf.DataBuf, (4+1+16)) == 0)
    {
        return 0;
    }
    else
...
Uint8 Prcss_BLE_CODE_SMP_Pairing_Failed(Uint8 connID)
{
    ...
    mblk->Primitive = (0x60+0x17);
    mblk->Para.MHC_Le_Auth_status_Para.HCI_Conn_Hdl_L = connID;
    mblk->Para.MHC_Le_Auth_status_Para.HCI_AUTH_STATUS = L2CAP_Buf.DataBuf[(0+4)+1];
    SndMsgBlk(mblk, 4);
    smp_Phase = 0;
    return 0;
}
Uint8 Prcss_BLE_CODE_SMP_Encryption_Information(Uint8 connID)
{
    ...
    for(i=0; i<16; i++)
    {
        smp_Temp16[i] = L2CAP_Buf.DataBuf[((0+4)+16)-i];     
    }
    return 0;
}
...
Uint8 Prcss_BLE_CODE_SMP_Master_Identification(Uint8 connID)
{
    ...
    for(i = 0; i<2; i++)
    {
        smp_EDIV[i] = L2CAP_Buf.DataBuf[(0+4)+2-i];
    }
    for(i = 0; i<8; i++)
    {
        smp_Rand[i] = L2CAP_Buf.DataBuf[(0+4)+1+8-i];
    }
...
Uint8 Prcss_BLE_CODE_SMP_Identity_Information(Uint8 connID)
{
    ...
    for(i = 0; i<16; i++)
    {
        smp_IRKm[i] = L2CAP_Buf.DataBuf[(0+4)+16-i];
    }
...
Uint8 Prcss_BLE_CODE_SMP_Signing_Information(Uint8 connID)
{
    ...
    for(i = 0; i<16; i++)
    {
        smp_CSRKm[i] = L2CAP_Buf.DataBuf[(0+4)+16-i];
    }
...
void SMEC_LE_CODE_SMP_Pairing_Confirm(MBLK *pMBlk)
{
    smpC1(k_AES_passkey, r_AES, SECBuffer);    

    setBLE_ConnTxData_SMP_Isr(pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_Conn_Hdl_L, 0x03, SECBuffer, 16);
    smp_Phase = 2;
}


void SMEC_LE_CODE_SMP_Pairing_Random(MBLK *pMBlk)
{
    Uint8 i;
    MBLK *mblk;
    Uint8 Mrand[16];

    Knl_MemCpyInv_Isr(Mrand, &pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_DataPkt_Data[((0+4)+1)], 16);
    smpC1(k_AES_passkey, Mrand, SECBuffer);

    if(smp_TempDef == 0x01)
    {
        if(Knl_MemComp_Isr(SECBuffer, smp_Temp16, 16)==0)
        {
            setBLE_ConnTxData_SMP_Isr(pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_Conn_Hdl_L, 0x04, r_AES, 16);

            
            
            smpS1(k_AES_passkey, r_AES, Mrand, smp_Temp16);                                                         

            smp_TempDef = 0x02;
            smp_Para_Bond[18] = 0x00;
        }
        else                                                                                            
        {
            i = 0x04;
            setBLE_ConnTxData_SMP_Isr(pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_Conn_Hdl_L, 0x05, &i, 1);
            smp_TempDef = 0x00;
            smp_Phase = 0;
            mblk = GetMsgBlk_Isr();
            mblk->Primitive = (0x60+0x17);
            mblk->Para.MHC_Le_Auth_status_Para.HCI_Conn_Hdl_L = pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_Conn_Hdl_L;
            mblk->Para.MHC_Le_Auth_status_Para.HCI_AUTH_STATUS = 0x04;
...
void SMEC_LE_SMP_Key_Gen(MBLK *pMBlk)
{
    extern Uint32 seedR16;

    smpAES_in_key(pMBlk->Para.HCLL_LE_ACL_Data_Pkt_Para.HCI_DataPkt_Data);
    smpAES_in_PlainText((Uint8 *)r_AES_INI);
    smpAES_En();

    smpAES_out(r_AES);      

    smpAES_in_PlainText((Uint8 *)LTK_FIXED);

    Knl_MemCpy_Isr(LTK, &r_AES[(r_AES[0]&0x03)], 10);
    Knl_MemCpy_Isr(LTK_SEED, &r_AES[(r_AES[0]&0x03)], 10);
    Knl_CodeCpy_Isr(&LTK[10], &RAND_FIXED[(LTK[0]&0x03)], 5);
    LTK[15] = EDIV_FIXED[(LTK[0]&0x01)];
...
void initBLEsmp_Re(void)
{
    extern const Uint8 TAB_ZERO_128[];

    smp_Security_Mode = 0x00;    
    smp_Encryption = 0;                     
    smp_Phase = 0;                          

    if(smp_Para_Bond[18]!=0x01)
    {
        Knl_CodeCpy(smp_Para_Bond, TAB_ZERO_128, (36+1));   
    }
}


void initBLEsmp(void)
{
    Uint8 i;
    ...
    for(i=0; i<11; i++) 
    {
        rsp_pairing_request_table[i] = RSP_PAIRING_REQUEST[i];
    }
