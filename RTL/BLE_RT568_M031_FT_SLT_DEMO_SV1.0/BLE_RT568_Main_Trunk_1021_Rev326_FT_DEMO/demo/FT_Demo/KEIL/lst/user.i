...
void BLEDemo_InitMessage(void)
{
    ...
    printf("7. RSSI Test (DUT RX) with Signal Generator\n");
...
RT568FT_TestStatus RT568_FTTestSelection(BleFT_TestCase testCase)
{
    ...
    case RSSI_DUTRX_TEST_WITH_SG:
    {
        ...
        status = RT568_RssiDUT_RxTest((-32),20, &rssiResult);
        printf("[RT568_FT RSSI DUT RX Test] RSSI: %d\n",rssiResult);  
    }
      break;
