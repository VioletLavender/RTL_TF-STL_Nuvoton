...
#line 22 "..\\..\\..\\source\\ble_cmd.c"
#line 23 "..\\..\\..\\source\\ble_cmd.c"
...
#line 25 "..\\..\\..\\source\\ble_cmd.c"

extern Uint8 chkBLE_LL_State_Adv(void);
extern Uint8 chkBLE_LL_State_Scan(void);
extern Uint8 chkBLE_LL_State_Init(void);
extern Uint8 LL_CheckConnExist(Uint8 LL_Conn_ID);
...
BleStackStatus setBLE_BleDeviceAddr(BLE_Addr_Param *addrParam)
{
    extern Uint8 BD_Rand_Addr[6];

    
    if( (chkBLE_LL_State_Adv()  != 0) ||
            (chkBLE_LL_State_Scan() != 0) ||
            (chkBLE_LL_State_Init() != 0) ||
            (LL_CheckConnExist((1 + 4 -1)) == (!0))) 
    {
        return 0x04;
    }

    if(((addrParam->addrType != 0x00) && (addrParam->addrType != 0x01)) ||
            ((addrParam->addrType == 0x01) && ((addrParam->addr[6 - 1] & 0xC0) != 0xC0 ))) 
    {
        return 0x03;
    }

    ble_device_param.ble_deviceAddr_param.addrType = addrParam->addrType;
    Knl_MemCpy(ble_device_param.ble_deviceAddr_param.addr, addrParam->addr, 6);

    if(addrParam->addrType == 0x01)
    {
        
        Knl_MemCpy(BD_Rand_Addr,addrParam->addr,6);
    }
...
void getBLE_BleDeviceAddr(BLE_Addr_Param *addrParam)
{
    addrParam->addrType = ble_device_param.ble_deviceAddr_param.addrType;
    Knl_MemCpy(addrParam->addr,ble_device_param.ble_deviceAddr_param.addr, 6);
}
...
BleStackStatus setBLE_AdvParam(BLE_Adv_Param advParam)
{
    ...
    if( (advParam.Adv_Interval_Min < 0x0020 || advParam.Adv_Interval_Min>0x4000) ||
            (advParam.Adv_Interval_Max < 0x0020 || advParam.Adv_Interval_Max>0x4000) ||
            (advParam.Adv_Interval_Min > advParam.Adv_Interval_Max) ||
            (advParam.Adv_Channel_Map > (0x01 | 0x02 | 0x04)) )
    {
        return 0x03;
    }

    switch(advParam.Adv_Type)
    {
    case 0x00:
    case 0x01:
    case 0x02:
    ...
    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Set_Adv_Param_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }
    ...
    {
    case 0x00:
        mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Type = 0x00;
        break;
    case 0x01:
        mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Type = 0x01;
        break;
    case 0x02:
        mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Type = 0x02;
        break;
    case 0x03:
        mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Type = 0x03;
        break;
    default:
        mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Type = 0x00;
        break;
    ...
    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Channel_Map = advParam.Adv_Channel_Map;

    
    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Filter_Policy = 0x00; 

    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Interval_Max = advParam.Adv_Interval_Max;
    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Adv_Interval_Min = advParam.Adv_Interval_Min;
    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Own_Addr_Type = ble_device_param.ble_deviceAddr_param.addrType;
    mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Direct_Addr_Type = advParam.Adv_DirectAddr_Param.addrType;

    Knl_CodeCpy( mblk->Para.HCLL_LE_Set_Adv_Param_Para.HCI_Direct_Addr, advParam.Adv_DirectAddr_Param.addr, 6);

    mblk->Primitive = (0xB0+0x18);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_AdvData(Uint8 *advData, Uint8 length)
{
    ...
    Knl_CodeCpy(mblk->Para.Data, advData, length);

    mblk->Primitive = (0xB0+0x1A);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ScanRspData(Uint8 *scanRspData, Uint8 length)
{
    ...
    Knl_CodeCpy(mblk->Para.Data, scanRspData, length);

    mblk->Primitive = (0xB0+0x1B);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_AdvEnable(void)
{
    ...
    if((LL_CheckConnExist((1 + 4 -1)) == (!0))) 
    {
        return 0x04;
    }

    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Set_Advertise_Enable_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_LE_Set_Advertise_Enable_Para.HCI_Adv_En = 0x01;
    mblk->Primitive = (0xB0+0x1C);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_AdvDisable(void)
{
    ...
    mblk->Para.HCLL_LE_Set_Advertise_Enable_Para.HCI_Adv_En = 0x00;
    mblk->Primitive = (0xB0+0x1C);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ScanParam(BLE_Scan_Param scanParam)
{
    ...
    if( (scanParam.Scan_Type!=0x00 && scanParam.Scan_Type!=0x01) ||
            (scanParam.Scan_Interval<0x0004 || scanParam.Scan_Interval>0x4000) ||
            (scanParam.Scan_Window<0x0004 || scanParam.Scan_Window>0x4000) ||
            (scanParam.Scan_Window > scanParam.Scan_Interval))
    {
        return 0x03;
    }

    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Set_Scan_Param_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_LE_Set_Scan_Param_Para.HCI_LEScanType = scanParam.Scan_Type;
    mblk->Para.HCLL_LE_Set_Scan_Param_Para.HCI_LE_Scan_Interval = scanParam.Scan_Interval;
    mblk->Para.HCLL_LE_Set_Scan_Param_Para.HCI_LE_Scan_Window = scanParam.Scan_Window;
    
    mblk->Para.HCLL_LE_Set_Scan_Param_Para.HCI_ScannFilterPolicy = 0x00; 
    mblk->Para.HCLL_LE_Set_Scan_Param_Para.HCI_Own_Addr_Type = ble_device_param.ble_deviceAddr_param.addrType;
    mblk->Primitive = (0xB0+0x1D);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ScanEnable(BleScanFilterPolicy scanFilter)
{
    ...
    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Set_Scan_Enable_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_LE_Set_Scan_Enable_Para.HCI_LE_Scan_En = 1;
    mblk->Para.HCLL_LE_Set_Scan_Enable_Para.HCI_Filter_Dupl = scanFilter; 
    mblk->Primitive = (0xB0+0x1E);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ScanDisable(void)
{
    ...
    mblk->Para.HCLL_LE_Set_Scan_Enable_Para.HCI_LE_Scan_En = 0;
    mblk->Primitive = (0xB0+0x1E);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_Disconnect(Uint8 connID)
{
    ...
    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_Disconnect_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_Disconnect_Para.HCI_Conn_Hdl_L = connID;
    mblk->Para.HCLL_Disconnect_Para.HCI_Reason = 0x13;
    mblk->Primitive = (0xB0+0x01);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ConnCreate(BLE_Addr_Param peerAddrParam, BLE_Scan_Param scanParam,BLE_Conn_Param connParam)
{
    ...
    if(((peerAddrParam.addrType != 0x00) && (peerAddrParam.addrType != 0x01)) ||
            ((peerAddrParam.addrType == 0x01) && ((peerAddrParam.addr[6 - 1] & 0xC0) != 0xC0 ))) 
    {
        return 0x03;
    }
    ...
    if( (connParam.Conn_IntervalMin<0x0006 || connParam.Conn_IntervalMin>0x0C80) ||
            (connParam.Conn_IntervalMax<0x0006 || connParam.Conn_IntervalMax>0x0C80) ||
            (connParam.Conn_IntervalMin > connParam.Conn_IntervalMax) ||
            (connParam.Conn_Latency>0x01F3) ||
            (connParam.Conn_SvisionTimeout<0x000A || connParam.Conn_SvisionTimeout>0x0C80) ||
            ((connParam.Conn_SvisionTimeout * 4) < ((1 + connParam.Conn_Latency) * connParam.Conn_IntervalMax )))
    {
        return 0x03;
    }


    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Create_Conn_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_ConnIntervalMax = connParam.Conn_IntervalMax;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_ConnIntervalMin = connParam.Conn_IntervalMin;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_ConnLatency = connParam.Conn_Latency;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_InitFilterPolicy = scanParam.Scan_FilterPolicy;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_LE_Scan_Interval = scanParam.Scan_Interval;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_LE_Scan_Window = scanParam.Scan_Window;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_MaxCELength = 12;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_MinCELength = 12;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_Own_Addr_Type = ble_device_param.ble_deviceAddr_param.addrType;
    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_SvisionTimeout = connParam.Conn_SvisionTimeout;

    mblk->Para.HCLL_LE_Create_Conn_Para.HCI_PeerAddrType = peerAddrParam.addrType;
    Knl_CodeCpy(mblk->Para.HCLL_LE_Create_Conn_Para.HCI_PeerAddr,peerAddrParam.addr, 6);

    mblk->Primitive = (0xB0+0x1F);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus setBLE_ConnCancel(void)
{
    ...
    if( chkBLE_LL_State_Init() == 0)
    {
        return 0x04;
    }

    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Create_Conn_Cancel_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Primitive = (0xB0+0x20);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
{
    MBLK *mblk;
    BLE_Conn_Param* param;
    extern Uint8 L2cap_Identifier;
    extern Uint8 setBLE_CmdTimer(Uint8 connID, CmdTimerEvent event, Uint32 timeout_base);
    extern uint8_t getBLE_CmdTimerEvent(uint8_t connID, CmdTimerEvent event);

    param = &connParam.connUpdateParam;
    if( (param->Conn_IntervalMin < 0x0006 || param->Conn_IntervalMin > 0x0C80) ||
            (param->Conn_IntervalMax < 0x0006 || param->Conn_IntervalMax > 0x0C80) ||
            (param->Conn_IntervalMin > param->Conn_IntervalMax) ||
            (param->Conn_Latency > 0x01F3) ||
            (param->Conn_SvisionTimeout < 0x000A || param->Conn_SvisionTimeout > 0x0C80) ||
            ((param->Conn_SvisionTimeout * 4) < ((1 + param->Conn_Latency) * param->Conn_IntervalMax )))
    {
        return 0x03;
    }


    if(connParam.connId < 4)   
    {
        
        if((LL_CheckConnExist(connParam.connId) == 0))
        {
            return 0x05;
        }

        mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Conn_Update_Para));
        if(mblk == (MBLK *)0)
        {
            return 0x01;
        }

        mblk->Para.HCLL_LE_Conn_Update_Para.HCI_Conn_Hdl_L = connParam.connId;
        mblk->Para.HCLL_LE_Conn_Update_Para.HCI_ConnIntervalMax = connParam.connUpdateParam.Conn_IntervalMax;
        mblk->Para.HCLL_LE_Conn_Update_Para.HCI_ConnIntervalMin = connParam.connUpdateParam.Conn_IntervalMin;
        mblk->Para.HCLL_LE_Conn_Update_Para.HCI_ConnLatency = connParam.connUpdateParam.Conn_Latency;
        mblk->Para.HCLL_LE_Conn_Update_Para.HCI_SvisionTimeout = connParam.connUpdateParam.Conn_SvisionTimeout;
        mblk->Primitive = (0xB0+0x25);
        SndMsgBlk(mblk, 0);
        return 0x00;
    }
    else     

    {
        ...
        if((connParam.connId > (1 + 4 -1)) || (LL_CheckConnExist((1 + 4 -1)) == 0)) 
        {
            return 0x05;
        }

        if((getBLE_CmdTimerEvent(connParam.connId, 0x00) == 0xFF) &&
                (getBLE_CmdTimerEvent(connParam.connId, 0x01) == 0xFF))
        {
            SPIBuffer[0] = 12;
            SPIBuffer[(0+1)] = 0;
            SPIBuffer[(0+2)] = 0x05;
            ...
            SPIBuffer[(0+4)] = 0x12;
            L2cap_Identifier++;
            SPIBuffer[((0+4)+1)] = L2cap_Identifier;
            SPIBuffer[((0+4)+2)] = 8;
            SPIBuffer[((0+4)+3)] = 0;
            Knl_MemCpy(&SPIBuffer[((0+4)+3)+1], (uint8_t *)&connParam.connUpdateParam, sizeof(connParam.connUpdateParam));
            if(setBLE_ConnTxData(connParam.connId, SPIBuffer, (SPIBuffer[0] + 4)) == (!0))
            {
                return 0x01;
            }

            setBLE_CmdTimer(connParam.connId, 0x00, 480000);  
            return 0x00;
        }
        else
        {
...
BleStackStatus setBLE_TxPower(BleTxPowerLevel txPower, BleMode bleMode)
{
    extern Uint8 setBLE_LL_TxPowerLevel_Adv(Uint8 powerLevel);
    extern Uint8 setBLE_LL_TxPowerLevel_Scan(Uint8 powerLevel);
    extern Uint8 setBLE_LL_TxPowerLevel_Init(Uint8 powerLevel);
    uint8_t errCode;
    ...
    {
    case 0x01:
        errCode = setBLE_LL_TxPowerLevel_Adv(txPower);
        break;
    case 0x03:
        errCode = setBLE_LL_TxPowerLevel_Scan(txPower);
        break;
    case 0x04:
        errCode = setBLE_LL_TxPowerLevel_Init(txPower);
        break;
    default:
        return 0x03;
    }
...
BleStackStatus setBLE_Phy(Uint8 connID, BLE_Phy_Param blePhy)
{
    ...
    if(((blePhy.tx_Phy != 0x01) && (blePhy.tx_Phy != 0x02)) ||
            (blePhy.rx_Phy != blePhy.tx_Phy))
    {
        return 0x03;
    }


    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_Le_Set_Phy_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_Le_Set_Phy_Para.HCI_Conn_Hdl_L = connID;
    mblk->Para.HCLL_Le_Set_Phy_Para.HCI_TxPhys = blePhy.tx_Phy;
    mblk->Para.HCLL_Le_Set_Phy_Para.HCI_RxPhys = blePhy.rx_Phy;
    mblk->Para.HCLL_Le_Set_Phy_Para.HCI_AllPhys = 0x00;
    mblk->Primitive = (0xB0+0x3D);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus getBLE_Phy(Uint8 connID)
{
    ...
    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_Le_Read_Phy_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Para.HCLL_Le_Read_Phy_Para.HCI_Conn_Hdl_L = connID;
    mblk->Primitive = (0xB0+0x3B);
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
BleStackStatus getBLE_RssiValue(Uint8 connID)
{
    ...
    if((connID > (1 + 4 -1)) || (LL_CheckConnExist(connID) == 0)) 
    {
        return 0x05;
    }
    ...
    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_Read_Rssi_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Primitive = (0xB0+0x13);
    mblk->Para.HCLL_Read_Rssi_Para.HCI_Conn_Hdl_L = connID;
    SndMsgBlk(mblk, 0);
    return 0x00;
}
...
void setBLE_RssiValueOffset(uint8_t offset)
{
    extern uint8_t rssiOffsetValue;
    rssiOffsetValue = offset;
}
...
BleStackStatus setBLE_SecurityRequest(Uint8 connID)
{
...

    {
        ...
        if(getBLE_CmdTimerEvent(connID, 0x02) == 0xFF)
        {
            if(setBLE_ConnTxData_SMP(connID, 0x0B, (Uint8 *)&rsp_pairing_request_table[((0+4)+3)], 1) == 0)
            {
                setBLE_CmdTimer(connID, 0x02, 240000);  
                return 0x00;
            }
            else
            {
...
BleStackStatus setBLE_Pairing_PassKey(Uint8 connID, Uint32 hexPasskey)
{
    ...
    if(smpPasskey_set(hexPasskey, connID) == 0)
    {
        return 0x00;
    }
    else
...
BleStackStatus setBLE_IOCapabilities(BLE_IO_Caps *Param)
{
    ...
    rsp_pairing_request_table[((0+4)+1)] = Param->IO_Param;

    if(Param->IO_Param == 0x03)
    {
        rsp_pairing_request_table[((0+4)+3)] &= ~(0x04);
    }
    else
    {
        rsp_pairing_request_table[((0+4)+3)] |= 0x04;
...
BleStackStatus setBLE_BondingFlags(BLE_Bonding_Flags *Param)
{
    ...
    if(Param->Flags == 0x01)
    {
        rsp_pairing_request_table[((0+4)+3)] |= 0x01;
    }
    else
    {
        rsp_pairing_request_table[((0+4)+3)] &= ~(0x01);
...
BleStackStatus setBLE_DataLength(BLE_DataLength_Param *Param)
{
    ...
    if((LL_CheckConnExist(Param->connId) == 0)) 
    {
        return 0x05;
    }

    if(((Param->RxMaxOctets) < 27) ||
            ((Param->RxMaxOctets) > 251) ||
            ((Param->TxMaxOctets) < 27) ||
            ((Param->TxMaxOctets) > 251) )
    {
        return 0x03;
    }

    mblk = GetMsgBlk_L2_wSize(sizeof(mblk->Para.HCLL_LE_Set_Data_Length_Para));
    if(mblk == (MBLK *)0)
    {
        return 0x01;
    }

    mblk->Primitive = (0xB0+0x3E);
    mblk->Para.HCLL_LE_Set_Data_Length_Para.HCI_Conn_Hdl_L = Param->connId;
    mblk->Para.HCLL_LE_Set_Data_Length_Para.HCI_RxOctets0 = Param->RxMaxOctets;
    mblk->Para.HCLL_LE_Set_Data_Length_Para.HCI_RxTime = ((Param->RxMaxOctets + 14u) << 3u);
    mblk->Para.HCLL_LE_Set_Data_Length_Para.HCI_TxOctets0 = Param->TxMaxOctets;
    mblk->Para.HCLL_LE_Set_Data_Length_Para.HCI_TxTime = ((Param->TxMaxOctets + 14u) << 3u);
...
BleStackStatus setBLE_exchangeMtuRequest(uint8_t connID, uint8_t client_rx_mtu)
{
    ...
    if(connID < 4)   
    {
        ...
        SPIBuffer[(0+3)] = 0;
        SPIBuffer[(0+4)] = 0X02;
        SPIBuffer[((0+4)+1)] = client_rx_mtu;
        SPIBuffer[((0+4)+2)] = client_rx_mtu >> 8;

        if(setBLE_ConnTxData(connID, SPIBuffer, (SPIBuffer[0] + 4)) == (!0))
        {
            return 0x01;
        }
        aTT_MTU[connID] = client_rx_mtu;
