...
#line 7 "..\\..\\..\\porting\\porting_misc.c"
#line 8 "..\\..\\..\\porting\\porting_misc.c"
#line 9 "..\\..\\..\\porting\\porting_misc.c"
#line 10 "..\\..\\..\\porting\\porting_misc.c"
#line 1 "..\\..\\..\\include\\ble_dtm.h"



#line 5 "..\\..\\..\\include\\ble_dtm.h"
...
#line 55 "..\\..\\..\\include\\ble_dtm.h"




 
#line 66 "..\\..\\..\\include\\ble_dtm.h"
...
#line 11 "..\\..\\..\\porting\\porting_misc.c"
...
void MCU_GpioResetInit(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0080)), (0x00000002UL), 0x1UL);
...
void MCU_GpioPinInit(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), (0x00008000UL), 0x0UL);
...
#line 102 "..\\..\\..\\porting\\porting_misc.c"
}

void MCU_GpioIntEnable(void)
{
#line 139 "..\\..\\..\\porting\\porting_misc.c"
    
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), (0x00008000UL), 0x0UL);

    if(ChipId_Get()==102u)
    {
        GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), 15, 0x00010000UL);
    }
    else
    {
        GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), 15, 0x01010000UL);
    }
    NVIC_EnableIRQ(GPIO_PCPDPEPF_IRQn);

#line 167 "..\\..\\..\\porting\\porting_misc.c"
...
void MCU_GpioIntDisable(void)
{
#line 183 "..\\..\\..\\porting\\porting_misc.c"
    GPIO_DisableInt(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), 15);
...
#line 234 "..\\..\\..\\porting\\porting_misc.c"
    if(((((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)))->INTSRC & ((0x00008000UL))))
    {
        ((((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)))->INTSRC = ((0x00008000UL)));
    }
    else
    {
        
        temp = ((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140))->INTSRC;
        ((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140))->INTSRC = temp;
    }
#line 256 "..\\..\\..\\porting\\porting_misc.c"

#line 273 "..\\..\\..\\porting\\porting_misc.c"
    LL_GPIO_Isr();      
...
#line 383 "..\\..\\..\\porting\\porting_misc.c"
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), (0x00000004UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), (0x00000001UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), (0x00000002UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), (0x00000008UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0140)), (0x00008000UL), 0x1UL);  
#line 395 "..\\..\\..\\porting\\porting_misc.c"
}
...
void RF_SpiIoMapping(void)
{
    ...
    CLK_SysTickDelay(50);
#line 494 "..\\..\\..\\porting\\porting_misc.c"
...
#line 526 "..\\..\\..\\porting\\porting_misc.c"
...
#line 553 "..\\..\\..\\porting\\porting_misc.c"
...
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->PORDISAN = 0x5AA5;
}
...
void System_PowerDown(void)
{
    if(BleRFMode_Get() == 0x01)  
    {
         
        while(!((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->FIFOSTS) & (0x1ul << (28))) >> (28)));

         
        SYS_UnlockReg();

         
        (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL |= (0x1ul << (7)));

         
        SYS_Disable_AnalogPORCircuit();

         
        (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->PORCTL = 0x5AA5);
...
{
    UART_Write(((UART_T *) ((( uint32_t)0x40000000) + 0x71000)),data,len);
    while(!((((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->FIFOSTS) & (0x1ul << (28))) >> (28)));
}
...
void MCU_WDTmr_En(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03UL) << 30)|((((0)) & 0x1fUL) << 0)| (((1) & 0x03UL) << 28)|(((3) & 0x07UL) << 25)|((((0)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x3UL<<(0)), 0);
...
#line 876 "..\\..\\..\\porting\\porting_misc.c"

#line 910 "..\\..\\..\\porting\\porting_misc.c"
